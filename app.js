...
container.addEventListener("click",(event)=>{
    ...
    else if(event.target.classList.contains("done-checkbox")){
...
// function saveTasks(){
//     let allTasks=[];
//     container.querySelectorAll("div").forEach( taskDiv=>{
//         let taskText=taskDiv.querySelector("span").innerText;
//         let isDone= taskDiv.querySelector(".done-checkbox").checked;
//         allTasks.push({text:taskText, done: isDone});
//     });
